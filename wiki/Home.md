...
- [GFF File Format](GFF-File-Format) ← Generic File Format
  - [ARE (Area)](GFF-File-Format#are-area)
  - [DLG (Dialogue)](GFF-File-Format#dlg-dialogue)
  - [GIT (Game Instance Template)](GFF-File-Format#git-game-instance-template)
  - [GUI](GFF-File-Format#gui)
  - [IFO (Module Info)](GFF-File-Format#ifo-module-info)
  - [JRL (Journal)](GFF-File-Format#jrl-journal)
  - [PTH (Path)](GFF-File-Format#pth-path)
  - [UTC (Creature)](GFF-File-Format#utc-creature)
  - [UTD (Door)](GFF-File-Format#utd-door)
  - [UTE (Encounter)](GFF-File-Format#ute-encounter)
  - [UTI (Item)](GFF-File-Format#uti-item)
  - [UTM (Merchant)](GFF-File-Format#utm-merchant)
  - [UTP (Placeable)](GFF-File-Format#utp-placeable)
  - [UTS (Sound)](GFF-File-Format#uts-sound)
  - [UTT (Trigger)](GFF-File-Format#utt-trigger)
  - [UTW (Waypoint)](GFF-File-Format#utw-waypoint)
