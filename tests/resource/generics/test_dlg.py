...
"""
    ...
    def validate_io(self, dlg: DLG):
        ...
        self.assertEqual(0xFFFFFFFF, entry0.Delay)
        ...
        self.assertEqual(-1, entry0.CamVidEffect)
        self.assertEqual(1, entry0.RecordNoVOOverri)

        self.assertEqual("bbb", dlg.StuntList[1].Participant)
        self.assertEqual("m01aa_c04_char01", dlg.StuntList[1].StuntModel)
