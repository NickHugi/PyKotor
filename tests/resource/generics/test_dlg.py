...
class TestDLG(TestCase):
    ...
    def validate_io(self, dlg):
        ...
        self.assertEqual(1, entry0.active1_param1)
        self.assertEqual(2, entry0.active2_param1)
        self.assertEqual(3, entry0.active1_param2)
        self.assertEqual(4, entry0.active2_param2)
        self.assertEqual(5, entry0.active1_param3)
        self.assertEqual(6, entry0.active2_param3)
        self.assertEqual(7, entry0.active1_param4)
        self.assertEqual(8, entry0.active2_param4)
        self.assertEqual(9, entry0.active1_param5)
        self.assertEqual(11, entry0.active2_param5)
        self.assertEqual("aaa", entry0.active1_param6)
        self.assertEqual("bbb", entry0.active2_param6)
