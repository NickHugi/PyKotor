...
@pytest.mark.parametrize("test_id, method, args, expected_result, expected_exception", [
...
@pytest.mark.parametrize("test_id, expected_closed", [
...
@pytest.mark.parametrize("test_id, file_content, offset, size, expected_result, expected_exception", [
