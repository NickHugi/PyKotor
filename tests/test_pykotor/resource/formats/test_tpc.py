...
class TestTPCData(unittest.TestCase):
    ...
    def test_different_color_patterns(self):
        ...
        mock_data: bytes = (b"\xff\x00\x00\x1f\x55\x55\x55\x55" + b"\x00\x1f\xff\x00\xaa\xaa\xaa\xaa") * 4
        result: bytearray = dxt1_to_rgb(mock_data, width, height)
    ...
    def test_dxt1_to_rgba(self, mockinterpolate_rgb, mockrgba565_to_rgb888, mockrgba565_to_rgb):
        ...
        expected = bytearray(
            [255, 0, 0, 255, 0, 255, 0, 255, 128, 128, 0, 255, 0, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255, 255, 0, 0, 255]
        )
