...
if ((Get-OS) -eq "Mac") {
    ...
    switch ($distro) {
        ...
        "oracle" {
            $command = "sudo dnf install binutils PyQt5 pulseaudio-libs-glib2 gstreamer1-plugins-base gstreamer1-plugins-good gstreamer1-plugins-bad-free gstreamer1-plugins-ugly-free gstreamer1-devel -y"
            break
        }
        "almalinux" {
