...
if ((Get-OS) -eq "Mac") {
    & bash -c "brew install python@3.8 qt pyqt5 mpdecimal gstreamer gst-plugins-base gst-plugins-good gst-plugins-bad gst-plugins-ugly pulseaudio fontconfig" 2>&1 | Write-Output 
