...
class GFFStruct:
    ...
    def get_locstring(self, label: str) -> LocalizedString:
        ...
        Returns:
            The field value as an LocalizedString.
        """
    ...
    def get_struct(self, label: str) -> GFFStruct:
        ...
        Returns:
            The field value as an GFFStruct.
        """
