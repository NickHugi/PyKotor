...
from pykotor.tslpatcher.twoda import Manipulation2DA, ChangeRow2DA, Target, TargetType, WarningException, AddRow2DA, \
...
class ConfigReader:
    ...
    def discern_2da(self, key: str, identifier: str, modifiers: Dict[str, str]) -> Manipulation2DA:
        if key.startswith("ChangeRow"):
            manipulation = ChangeRow2DA()
