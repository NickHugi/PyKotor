...
function Find-Python {
    ...
    if ($global:force_python_version) {
        ...
        $pythonVersions = $pythonVersions = @('pypy3.8', 'pypy3.9', 'pypy3.10', 'pypy3.11', 'pypy3.12', 'python3.8', 'python3', 'python3.9', 'python3.10', 'python3.11', 'python3.12', 'python3.13', 'python3.14', 'python')
    }
