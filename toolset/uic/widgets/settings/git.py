...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 429, 897))
        ...
        self.duplicateObjectBindEdit = SetBindWidget(self.groupBox)
        self.duplicateObjectBindEdit.setObjectName("duplicateObjectBindEdit")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.duplicateObjectBindEdit)
