...
class DLGEditor(Editor):
    ...
    def onNodeUpdate(self) -> None:
        if self.ui.dialogTree.selectedIndexes() and self.acceptUpdates:
            ...
            node.script1_param2 = self.ui.script1Param1Spin.value()
            node.script1_param3 = self.ui.script1Param1Spin.value()
            node.script1_param4 = self.ui.script1Param1Spin.value()
            node.script1_param5 = self.ui.script1Param1Spin.value()
            ...
            node.script2_param2 = self.ui.script2Param1Spin.value()
            node.script2_param3 = self.ui.script2Param1Spin.value()
            node.script2_param4 = self.ui.script2Param1Spin.value()
            node.script2_param5 = self.ui.script2Param1Spin.value()
            ...
            link.active1_param2 = self.ui.condition1Param1Spin.value()
            link.active1_param3 = self.ui.condition1Param1Spin.value()
            ...
            link.active2_param2 = self.ui.condition2Param1Spin.value()
            link.active2_param3 = self.ui.condition2Param1Spin.value()
            link.active2_param4 = self.ui.condition2Param1Spin.value()
            link.active2_param5 = self.ui.condition2Param1Spin.value()
...
class EditAnimationDialog(QDialog):
    ...
    def animation(self) -> DLGAnimation:
        ...
        animation.animation_id = 6 if animation_id is None else animation_id
