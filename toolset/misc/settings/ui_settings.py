...
# Form implementation generated from reading ui file 'misc\settings\settings.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.settingsTree.topLevelItem(1).setText(0, _translate("Dialog", "Misc"))
        self.settingsTree.setSortingEnabled(__sortingEnabled)
from misc.settings.pages import InstallationsWidget, MiscWidget
