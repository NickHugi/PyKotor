...
`resolve_resource_in_installation` - Resource Resolution

**Location:** resolution.py:87  
...
**ile.py:205(data):** 105,900 calls, 142.350 seconds cumulative  
**stream.py:135(from_file):** 107,278 calls, 136.046 seconds cumulative
...
**
reference_cache.py:734(find_all_strref_references):** 2 calls, **274.068 seconds** cumulative

- Calls file.py:205(data) 103,050 times (141.665 seconds)
- Calls
reference_cache.py:150(scan_resource) 103,050 times (112.069 seconds)

**
reference_cache.py:230(_scan_ncs):** 15,314 calls, **9.609 seconds** self time, 46.865 cumulative
...
**stream.py:459(read_uint32):** 15,013,179 calls, **18.263 seconds** self time  
**stream.py:383(read_uint8):** 15,417,646 calls, **16.845 seconds** self time  
**stream.py:785(exceed_check):** 50,356,178 calls, 8.089 seconds self time
