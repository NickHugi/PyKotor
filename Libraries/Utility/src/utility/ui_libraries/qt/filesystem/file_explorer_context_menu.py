...
from utility.system.path import Path as CaseAwarePath
...
class FileExplorerContextMenu:
    ...
    def create_item_menu(self, menu, index):
    ...
    def create_background_menu(self, menu):
    ...
    def open_item(self, index):
        ...
        self.file_explorer.on_file_view_double_clicked(index)
    ...
    def delete_items(self, indexes: List[QModelIndex]):
        ...
        reply = QMessageBox.question(self.file_explorer, "Confirm Delete",
