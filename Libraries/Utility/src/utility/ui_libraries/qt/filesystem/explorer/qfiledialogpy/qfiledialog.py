...
from utility.ui_libraries.qt.filesystem.explorer.qfiledialog.private.qfiledialog_p import QFileDialogOptions, QFileDialogPrivate
...
class QFileDialog(QDialog):
    ...
    def setSidebarUrls(self, urls: list[QUrl]) -> None:
        ...
        if self._private.usingWidgets():
            self._private.qFileDialogUi.sidebar.setUrls(urls)
