...
from utility.ui_libraries.qt.adapters.filesystem.qfiledialog.rewritten.private.qsidebar import QUrlModel
...
class QFileDialogComboBox(QComboBox):
    ...
    def _d_ptr(self) -> QFileDialogPrivate:
        from utility.ui_libraries.qt.adapters.filesystem.qfiledialog.rewritten.qfiledialog import QFileDialog as PublicQFileDialog
