...
class RobustListView(RobustAbstractItemView, QListView):
    ...
    def build_context_menu(
        ...
        self._add_simple_action(actions_menu, "Scroll to Top", lambda: self.scrollTo(self.model().index(0, 0), QListView.ScrollHint.PositionAtTop))
        self._add_simple_action(actions_menu, "Scroll to Bottom", lambda: self.scrollTo(self.model().index(self.model().rowCount() - 1, 0), QListView.ScrollHint.PositionAtBottom))
