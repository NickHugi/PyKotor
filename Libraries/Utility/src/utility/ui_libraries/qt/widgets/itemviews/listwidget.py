...
class RobustListWidget(QListWidget, RobustListView):
    ...
    def build_context_menu(self) -> QMenu:
        ...
        list_widget_menu = menu.addMenu("ListWidget")
        ...
        # Selection
        selection_menu = list_widget_menu.addMenu("Selection")
        ...
        # Item manipulation
        item_menu = list_widget_menu.addMenu("Item Actions")
        ...
        # View options
        view_menu = list_widget_menu.addMenu("View Options")
        ...
        # Advanced options
        advanced_menu = list_widget_menu.addMenu("Advanced")
