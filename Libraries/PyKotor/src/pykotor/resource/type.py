...
class ResourceType(Enum):
    ...
    KA  = ResourceTuple(2075, "ka", "Unused", "xml")
    JPG = ResourceTuple(2076, "jpg", "Images", "binary")
    ICO = ResourceTuple(2077, "Images", "binary")
    OGG = ResourceTuple(2078, "Audio", "binary")
    SPT = ResourceTuple(2079, "Unused", "binary")
    SPW = ResourceTuple(2080, "Unused", "binary")
    WFX = ResourceTuple(2081, "Unused", "xml")
    UGM = ResourceTuple(2082, "Unused", "binary")
    QDB = ResourceTuple(2083, "Unused", "gff")
    QST = ResourceTuple(2084, "Unused", "gff")
    NPC = ResourceTuple(2085, "Unused", "binary")
    SPN = ResourceTuple(2086, "Unused", "binary")
    UTX = ResourceTuple(2087, "Unused", "binary")
    MMD = ResourceTuple(2088, "Unused", "binary")
    SMM = ResourceTuple(2089, "Unused", "binary")
    UTA = ResourceTuple(2090, "Unused", "binary")
    MDE = ResourceTuple(2091, "Unused", "binary")
    MDV = ResourceTuple(2092, "Unused", "binary")
    MDA = ResourceTuple(2093, "Unused", "binary")
    MBA = ResourceTuple(2094, "Unused", "binary")
    OCT = ResourceTuple(2095, "Unused", "binary")
    BFX = ResourceTuple(2096, "Unused", "binary")
    PDB = ResourceTuple(2097, "Unused", "binary")
    PVS = ResourceTuple(2099, "Unused", "binary")
