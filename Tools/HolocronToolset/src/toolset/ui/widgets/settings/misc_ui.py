...
class Ui_Form:
    ...
    def retranslateUi(self, Form):
        ...
        self.saveRimCheck.setText(QCoreApplication.translate("Form", "Allow saving resources to RIM files.", None))
        self.useBetaChannel.setText(QCoreApplication.translate("Form", "Check for beta updates and take me to their download link when they're available.", None))
        self.alsoCheckReleaseVersion.setText(QCoreApplication.translate("Form", "Also check release version if it is newer than beta version.", None))
        self.mergeRimCheck.setText(QCoreApplication.translate("Form", "Merge secondary ERF/RIM's in the Modules tab of the Main Window (i.e. '_s.rim' and '_dlg.erf').", None))
        self.attemptKeepOldGFFFields.setText(QCoreApplication.translate("Form", "Attempts to keep any pre-existing GFF fields when saving the editor. Required for save editing.", None))
        self.moduleSortOptionComboBox.setItemText(0, QCoreApplication.translate("Form", "Sort by filename", None))
        self.moduleSortOptionComboBox.setItemText(1, QCoreApplication.translate("Form", "Sort by humanized area name", None))
        self.moduleSortOptionComboBox.setItemText(2, QCoreApplication.translate("Form", "Sort by area name", None))

        self.greyRimCheck.setText(QCoreApplication.translate("Form", "Set RIM files to have grey text in the Modules tab of the Main Window.", None))
        self.showPreviewUTCCheck.setText(QCoreApplication.translate("Form", "Show 3D Preview in UTC Editor", None))
        self.showPreviewUTPCheck.setText(QCoreApplication.translate("Form", "Show 3D Preview in UTP Editor", None))
        self.showPreviewUTDCheck.setText(QCoreApplication.translate("Form", "Show 3D Preview in UTD Editor", None))
        self.profileToolset.setText(QCoreApplication.translate("Form", "Profile various subroutines of the toolset.", None))
        self.label.setText(QCoreApplication.translate("Form", "Temp Directory:", None))
        self.label_5.setText(QCoreApplication.translate("Form", "GFF Files:", None))
        self.gffEditorCombo.setItemText(0, QCoreApplication.translate("Form", "GFF Editor", None))
        self.gffEditorCombo.setItemText(1, QCoreApplication.translate("Form", "Specialized Editor", None))

        self.label_4.setText(QCoreApplication.translate("Form", "NSS Compiler:", None))
        self.label_10.setText(QCoreApplication.translate("Form", "NCS Decompiler:", None))
    # retranslateUi
