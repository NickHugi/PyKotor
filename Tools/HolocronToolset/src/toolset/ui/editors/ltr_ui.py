...
class Ui_MainWindow:
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", "LTR Editor", None))
        ...
        self.labelSingleChar.setText(QCoreApplication.translate("MainWindow", "Character", None))
        self.labelSingleStart.setText(QCoreApplication.translate("MainWindow", "Start", None))
        self.labelSingleMiddle.setText(QCoreApplication.translate("MainWindow", "Middle", None))
        self.labelSingleEnd.setText(QCoreApplication.translate("MainWindow", "End", None))
        self.buttonSetSingle.setText(QCoreApplication.translate("MainWindow", "Set Single Character", None))
        ___qtablewidgetitem = self.tableSingles.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("MainWindow", "Character", None));
        ___qtablewidgetitem1 = self.tableSingles.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", "Start", None));
        ___qtablewidgetitem2 = self.tableSingles.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", "Middle", None));
        ___qtablewidgetitem3 = self.tableSingles.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", "End", None));
        self.buttonAddSingle.setText(QCoreApplication.translate("MainWindow", "Add Row", None))
        self.buttonRemoveSingle.setText(QCoreApplication.translate("MainWindow", "Remove Selected Row", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabSingles), QCoreApplication.translate("MainWindow", "Singles", None))
        self.labelDoublePrevChar.setText(QCoreApplication.translate("MainWindow", "Previous Character", None))
        self.labelDoubleChar.setText(QCoreApplication.translate("MainWindow", "Character", None))
        self.labelDoubleStart.setText(QCoreApplication.translate("MainWindow", "Start", None))
        self.labelDoubleMiddle.setText(QCoreApplication.translate("MainWindow", "Middle", None))
        self.labelDoubleEnd.setText(QCoreApplication.translate("MainWindow", "End", None))
        self.buttonSetDouble.setText(QCoreApplication.translate("MainWindow", "Set Double Character", None))
        ___qtablewidgetitem4 = self.tableDoubles.horizontalHeaderItem(0)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", "Previous Character", None));
        ___qtablewidgetitem5 = self.tableDoubles.horizontalHeaderItem(1)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("MainWindow", "Character", None));
        ___qtablewidgetitem6 = self.tableDoubles.horizontalHeaderItem(2)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("MainWindow", "Start", None));
        ___qtablewidgetitem7 = self.tableDoubles.horizontalHeaderItem(3)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("MainWindow", "Middle", None));
        ___qtablewidgetitem8 = self.tableDoubles.horizontalHeaderItem(4)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("MainWindow", "End", None));
        self.buttonAddDouble.setText(QCoreApplication.translate("MainWindow", "Add Row", None))
        self.buttonRemoveDouble.setText(QCoreApplication.translate("MainWindow", "Remove Selected Row", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabDoubles), QCoreApplication.translate("MainWindow", "Doubles", None))
        self.labelTriplePrev2Char.setText(QCoreApplication.translate("MainWindow", "Previous Character 2", None))
        self.labelTriplePrev1Char.setText(QCoreApplication.translate("MainWindow", "Previous Character 1", None))
        self.labelTripleChar.setText(QCoreApplication.translate("MainWindow", "Character", None))
        self.labelTripleStart.setText(QCoreApplication.translate("MainWindow", "Start", None))
        self.labelTripleMiddle.setText(QCoreApplication.translate("MainWindow", "Middle", None))
        self.labelTripleEnd.setText(QCoreApplication.translate("MainWindow", "End", None))
        self.buttonSetTriple.setText(QCoreApplication.translate("MainWindow", "Set Triple Character", None))
        ___qtablewidgetitem9 = self.tableTriples.horizontalHeaderItem(0)
        ___qtablewidgetitem9.setText(QCoreApplication.translate("MainWindow", "Previous Character 2", None));
        ___qtablewidgetitem10 = self.tableTriples.horizontalHeaderItem(1)
        ___qtablewidgetitem10.setText(QCoreApplication.translate("MainWindow", "Previous Character 1", None));
        ___qtablewidgetitem11 = self.tableTriples.horizontalHeaderItem(2)
        ___qtablewidgetitem11.setText(QCoreApplication.translate("MainWindow", "Character", None));
        ___qtablewidgetitem12 = self.tableTriples.horizontalHeaderItem(3)
        ___qtablewidgetitem12.setText(QCoreApplication.translate("MainWindow", "Start", None));
        ___qtablewidgetitem13 = self.tableTriples.horizontalHeaderItem(4)
        ___qtablewidgetitem13.setText(QCoreApplication.translate("MainWindow", "Middle", None));
        ___qtablewidgetitem14 = self.tableTriples.horizontalHeaderItem(5)
        ___qtablewidgetitem14.setText(QCoreApplication.translate("MainWindow", "End", None));
        self.buttonAddTriple.setText(QCoreApplication.translate("MainWindow", "Add Row", None))
        self.buttonRemoveTriple.setText(QCoreApplication.translate("MainWindow", "Remove Selected Row", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabTriples), QCoreApplication.translate("MainWindow", "Triples", None))
        self.buttonGenerate.setText(QCoreApplication.translate("MainWindow", "Generate Name", None))
        self.lineEditGeneratedName.setPlaceholderText(QCoreApplication.translate("MainWindow", "Generated Name", None))
