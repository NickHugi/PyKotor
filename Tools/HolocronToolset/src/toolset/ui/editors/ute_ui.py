...
class Ui_MainWindow:
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_39.setText(QCoreApplication.translate("MainWindow", "Difficulty:", None))
        self.label_40.setText(QCoreApplication.translate("MainWindow", "Min Creatures:", None))
        self.label_41.setText(QCoreApplication.translate("MainWindow", "Max Creatures:", None))
        self.label_42.setText(QCoreApplication.translate("MainWindow", "Spawn Option:", None))
        self.spawnSelect.setItemText(0, QCoreApplication.translate("MainWindow", "Single Shot", None))
        self.spawnSelect.setItemText(1, QCoreApplication.translate("MainWindow", "Continuous", None))
        ...
        self.playerOnlyCheckbox.setText(QCoreApplication.translate("MainWindow", "Player Triggered Only", None))
        self.label.setText(QCoreApplication.translate("MainWindow", "Faction:", None))
        self.respawnsCheckbox.setText(QCoreApplication.translate("MainWindow", "Respawns", None))
        self.infiniteRespawnCheckbox.setText(QCoreApplication.translate("MainWindow", "Infinite Respawns", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", "Respawn Time (s):", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", "Number of Respawns:", None))
        ...
        ___qtablewidgetitem.setText(QCoreApplication.translate("MainWindow", "SingleSpawn", None));
        ___qtablewidgetitem1 = self.creatureTable.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", "CR", None));
        ___qtablewidgetitem2 = self.creatureTable.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", "Appearance", None));
        ___qtablewidgetitem3 = self.creatureTable.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", "ResRef", None));
        self.removeCreatureButton.setText(QCoreApplication.translate("MainWindow", "Remove", None))
        self.addCreatureButton.setText(QCoreApplication.translate("MainWindow", "Add", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_5), QCoreApplication.translate("MainWindow", "Creatures", None))
        self.label_4.setText(QCoreApplication.translate("MainWindow", "OnEnter:", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", "OnExit:", None))
        self.label_7.setText(QCoreApplication.translate("MainWindow", "OnExhausted:", None))
        self.label_8.setText(QCoreApplication.translate("MainWindow", "OnHeartbeat:", None))
        self.label_9.setText(QCoreApplication.translate("MainWindow", "OnUserDefined:", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), QCoreApplication.translate("MainWindow", "Scripts", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), QCoreApplication.translate("MainWindow", "Comments", None))
