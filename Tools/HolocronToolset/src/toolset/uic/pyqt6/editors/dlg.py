...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 348, 1026))
        ...
        self.horizontalLayout_2.addWidget(self.script2Label, 0, QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.horizontalLayout_3.addWidget(self.conditional1Label, 0, QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.horizontalLayout_4.addWidget(self.conditional2Label, 0, QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.topDockWidget.setMinimumSize(QtCore.QSize(717, 148))
        ...
        self.topGridLayout = QtWidgets.QGridLayout(self.topDockWidgetContents)
        ...
        self.topGridLayout.addWidget(self.convoTypeLabel, 2, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.skippableCheckbox = QtWidgets.QCheckBox(parent=self.topDockWidgetContents)
        ...
        self.unequipAllCheckbox = QtWidgets.QCheckBox(parent=self.topDockWidgetContents)
        ...
        self.topGridLayout.addWidget(self.convoAbortsScriptLabel, 1, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.topGridLayout.addWidget(self.computerTypeLabel, 3, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.unequipHandsCheckbox = QtWidgets.QCheckBox(parent=self.topDockWidgetContents)
        ...
        self.animatedCutCheckbox = QtWidgets.QCheckBox(parent=self.topDockWidgetContents)
        ...
        self.oldHitCheckbox = QtWidgets.QCheckBox(parent=self.topDockWidgetContents)
        self.oldHitCheckbox.setObjectName("oldHitCheckbox")
        self.topGridLayout.addWidget(self.oldHitCheckbox, 3, 4, 1, 1, QtCore.Qt.AlignmentFlag.AlignLeft)
        spacerItem9 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.topGridLayout.addItem(spacerItem9, 2, 6, 1, 1)
        spacerItem10 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.topGridLayout.addItem(spacerItem10, 1, 6, 1, 1)
        spacerItem11 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.topGridLayout.addItem(spacerItem11, 0, 6, 1, 1)
        spacerItem12 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.topGridLayout.addItem(spacerItem12, 3, 6, 1, 1)
