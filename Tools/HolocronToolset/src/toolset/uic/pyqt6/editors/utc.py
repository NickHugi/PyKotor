...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.firstnameEdit = LocalizedStringLineEdit(parent=self.groupBox)
        ...
        self.firstnameRandomButton = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.lastnameEdit = LocalizedStringLineEdit(parent=self.groupBox)
        ...
        self.lastnameRandomButton = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        spacerItem = QtWidgets.QSpacerItem(32, 0, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(32, 0, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_8.addItem(spacerItem1)
        spacerItem2 = QtWidgets.QSpacerItem(32, 0, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_8.addItem(spacerItem2)
        self.formLayout.setLayout(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_8)
        ...
        spacerItem3 = QtWidgets.QSpacerItem(32, 0, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_4.addItem(spacerItem3)
        spacerItem4 = QtWidgets.QSpacerItem(32, 0, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        self.soundsetSelect = ComboBox2DA(parent=self.groupBox)
        self.soundsetSelect.setObjectName("soundsetSelect")
        self.horizontalLayout_10.addWidget(self.soundsetSelect)
        spacerItem5 = QtWidgets.QSpacerItem(32, 0, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_10.addItem(spacerItem5)
        spacerItem6 = QtWidgets.QSpacerItem(32, 0, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_10.addItem(spacerItem6)
        self.formLayout.setLayout(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_10)
        ...
        spacerItem7 = QtWidgets.QSpacerItem(32, 0, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        self.portraitPicture = QtWidgets.QLabel(parent=self.groupBox_2)
        ...
        self.portraitSelect = ComboBox2DA(parent=self.groupBox_2)
        ...
        self.groupBox_4 = QtWidgets.QGroupBox(parent=self.advancedTab)
        ...
        self.raceSelect = ComboBox2DA(parent=self.groupBox_4)
        self.raceSelect.setObjectName("raceSelect")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.raceSelect)
        ...
        self.subraceSelect = ComboBox2DA(parent=self.groupBox_4)
        self.subraceSelect.setObjectName("subraceSelect")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.subraceSelect)
        self.verticalLayout_4.addWidget(self.groupBox_4)
        self.groupBox_5 = QtWidgets.QGroupBox(parent=self.advancedTab)
        ...
        self.speedSelect = ComboBox2DA(parent=self.groupBox_5)
        self.speedSelect.setObjectName("speedSelect")
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.speedSelect)
        ...
        self.factionSelect = ComboBox2DA(parent=self.groupBox_5)
        self.factionSelect.setObjectName("factionSelect")
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.factionSelect)
        self.label_99 = QtWidgets.QLabel(parent=self.groupBox_5)
        self.label_99.setObjectName("label_99")
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_99)
        self.genderSelect = ComboBox2DA(parent=self.groupBox_5)
        self.genderSelect.setObjectName("genderSelect")
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.genderSelect)
        ...
        self.perceptionSelect = ComboBox2DA(parent=self.groupBox_5)
        self.perceptionSelect.setObjectName("perceptionSelect")
        self.formLayout_3.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.perceptionSelect)
        self.label_13 = QtWidgets.QLabel(parent=self.groupBox_5)
        self.label_13.setObjectName("label_13")
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_13)
        self.challengeRatingSpin = QtWidgets.QDoubleSpinBox(parent=self.groupBox_5)
        self.challengeRatingSpin.setObjectName("challengeRatingSpin")
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.challengeRatingSpin)
        self.verticalLayout_18.addLayout(self.formLayout_3)
        self.k2onlyBox = QtWidgets.QFrame(parent=self.groupBox_5)
        self.k2onlyBox.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.k2onlyBox.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        ...
        self.label_102 = QtWidgets.QLabel(parent=self.k2onlyBox)
        self.label_102.setObjectName("label_102")
        self.formLayout_24.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_102)
        self.blindSpotSpin = QtWidgets.QDoubleSpinBox(parent=self.k2onlyBox)
        self.blindSpotSpin.setObjectName("blindSpotSpin")
        self.formLayout_24.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.blindSpotSpin)
        self.label_110 = QtWidgets.QLabel(parent=self.k2onlyBox)
        self.label_110.setObjectName("label_110")
        self.formLayout_24.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_110)
        self.line = QtWidgets.QFrame(parent=self.k2onlyBox)
        self.line.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line.setObjectName("line")
        self.formLayout_24.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.line)
        self.multiplierSetSpin = QtWidgets.QSpinBox(parent=self.k2onlyBox)
        ...
        self.formLayout_24.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.multiplierSetSpin)
        ...
        self.groupBox_6 = QtWidgets.QGroupBox(parent=self.statsTab)
        ...
        self.computerUseSpin = QtWidgets.QSpinBox(parent=self.groupBox_6)
        ...
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.computerUseSpin)
        ...
        self.demolitionsSpin = QtWidgets.QSpinBox(parent=self.groupBox_6)
        ...
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.demolitionsSpin)
        ...
        self.stealthSpin = QtWidgets.QSpinBox(parent=self.groupBox_6)
        self.stealthSpin.setMinimum(-2147483648)
        self.stealthSpin.setMaximum(2147483647)
        self.stealthSpin.setObjectName("stealthSpin")
        self.formLayout_4.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.stealthSpin)
        self.label_20 = QtWidgets.QLabel(parent=self.groupBox_6)
        self.label_20.setObjectName("label_20")
        self.formLayout_4.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_20)
        self.awarenessSpin = QtWidgets.QSpinBox(parent=self.groupBox_6)
        ...
        self.formLayout_4.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.awarenessSpin)
        self.label_21 = QtWidgets.QLabel(parent=self.groupBox_6)
        self.label_21.setObjectName("label_21")
        self.formLayout_4.setWidget(4, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_21)
        self.persuadeSpin = QtWidgets.QSpinBox(parent=self.groupBox_6)
        ...
        self.formLayout_4.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.persuadeSpin)
        self.label_22 = QtWidgets.QLabel(parent=self.groupBox_6)
        self.label_22.setObjectName("label_22")
        self.formLayout_4.setWidget(5, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_22)
        self.repairSpin = QtWidgets.QSpinBox(parent=self.groupBox_6)
        self.repairSpin.setMinimum(-2147483648)
        self.repairSpin.setMaximum(2147483647)
        self.repairSpin.setObjectName("repairSpin")
        self.formLayout_4.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.repairSpin)
        ...
        self.securitySpin = QtWidgets.QSpinBox(parent=self.groupBox_6)
        ...
        self.formLayout_4.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.securitySpin)
        ...
        self.treatInjurySpin = QtWidgets.QSpinBox(parent=self.groupBox_6)
        ...
        self.formLayout_4.setWidget(7, QtWidgets.QFormLayout.ItemRole.FieldRole, self.treatInjurySpin)
        self.verticalLayout_5.addWidget(self.groupBox_6)
        self.groupBox_8 = QtWidgets.QGroupBox(parent=self.statsTab)
        ...
        self.formLayout_6.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_31)
        self.fortitudeSpin = QtWidgets.QSpinBox(parent=self.groupBox_8)
        ...
        self.formLayout_6.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.fortitudeSpin)
        self.label_32 = QtWidgets.QLabel(parent=self.groupBox_8)
        self.label_32.setObjectName("label_32")
        self.formLayout_6.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_32)
        self.label_33 = QtWidgets.QLabel(parent=self.groupBox_8)
        self.label_33.setObjectName("label_33")
        self.formLayout_6.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_33)
        self.reflexSpin = QtWidgets.QSpinBox(parent=self.groupBox_8)
        self.reflexSpin.setMinimum(-2147483648)
        self.reflexSpin.setMaximum(2147483647)
        self.reflexSpin.setObjectName("reflexSpin")
        self.formLayout_6.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.reflexSpin)
        self.willSpin = QtWidgets.QSpinBox(parent=self.groupBox_8)
        self.willSpin.setMinimum(-2147483648)
        self.willSpin.setMaximum(2147483647)
        self.willSpin.setObjectName("willSpin")
        self.formLayout_6.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.willSpin)
        self.verticalLayout_5.addWidget(self.groupBox_8)
        self.groupBox_9 = QtWidgets.QGroupBox(parent=self.statsTab)
        ...
        self.armorClassSpin = QtWidgets.QSpinBox(parent=self.groupBox_9)
        ...
        self.formLayout_7.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.armorClassSpin)
        ...
        self.groupBox_7 = QtWidgets.QGroupBox(parent=self.statsTab)
        ...
        self.formLayout_5.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_25)
        self.strengthSpin = QtWidgets.QSpinBox(parent=self.groupBox_7)
        ...
        self.formLayout_5.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.strengthSpin)
        self.label_26 = QtWidgets.QLabel(parent=self.groupBox_7)
        self.label_26.setObjectName("label_26")
        self.formLayout_5.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_26)
        self.dexteritySpin = QtWidgets.QSpinBox(parent=self.groupBox_7)
        ...
        self.formLayout_5.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.dexteritySpin)
        self.label_27 = QtWidgets.QLabel(parent=self.groupBox_7)
        self.label_27.setObjectName("label_27")
        self.formLayout_5.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_27)
        self.constitutionSpin = QtWidgets.QSpinBox(parent=self.groupBox_7)
        ...
        self.formLayout_5.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.constitutionSpin)
        self.label_28 = QtWidgets.QLabel(parent=self.groupBox_7)
        self.label_28.setObjectName("label_28")
        self.formLayout_5.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_28)
        self.intelligenceSpin = QtWidgets.QSpinBox(parent=self.groupBox_7)
        ...
        self.formLayout_5.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.intelligenceSpin)
        self.label_29 = QtWidgets.QLabel(parent=self.groupBox_7)
        self.label_29.setObjectName("label_29")
        self.formLayout_5.setWidget(4, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_29)
        self.wisdomSpin = QtWidgets.QSpinBox(parent=self.groupBox_7)
        self.wisdomSpin.setMinimum(-2147483648)
        self.wisdomSpin.setMaximum(2147483647)
        self.wisdomSpin.setObjectName("wisdomSpin")
        self.formLayout_5.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.wisdomSpin)
        self.label_30 = QtWidgets.QLabel(parent=self.groupBox_7)
        self.label_30.setObjectName("label_30")
        self.formLayout_5.setWidget(5, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_30)
        self.charismaSpin = QtWidgets.QSpinBox(parent=self.groupBox_7)
        ...
        self.formLayout_5.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.charismaSpin)
        self.verticalLayout_6.addWidget(self.groupBox_7)
        self.groupBox_10 = QtWidgets.QGroupBox(parent=self.statsTab)
        ...
        self.formLayout_8.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_35)
        self.label_36 = QtWidgets.QLabel(parent=self.groupBox_10)
        self.label_36.setObjectName("label_36")
        self.formLayout_8.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_36)
        self.label_37 = QtWidgets.QLabel(parent=self.groupBox_10)
        self.label_37.setObjectName("label_37")
        self.formLayout_8.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_37)
        self.baseHpSpin = QtWidgets.QSpinBox(parent=self.groupBox_10)
        self.baseHpSpin.setMinimum(-2147483648)
        self.baseHpSpin.setMaximum(2147483647)
        self.baseHpSpin.setObjectName("baseHpSpin")
        self.formLayout_8.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.baseHpSpin)
        self.currentHpSpin = QtWidgets.QSpinBox(parent=self.groupBox_10)
        ...
        self.formLayout_8.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.currentHpSpin)
        self.maxHpSpin = QtWidgets.QSpinBox(parent=self.groupBox_10)
        self.maxHpSpin.setMinimum(-2147483648)
        self.maxHpSpin.setMaximum(2147483647)
        self.maxHpSpin.setObjectName("maxHpSpin")
        self.formLayout_8.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.maxHpSpin)
        self.verticalLayout_6.addWidget(self.groupBox_10)
        self.groupBox_11 = QtWidgets.QGroupBox(parent=self.statsTab)
        self.groupBox_11.setObjectName("groupBox_11")
        self.formLayout_9 = QtWidgets.QFormLayout(self.groupBox_11)
        self.formLayout_9.setObjectName("formLayout_9")
        self.label_39 = QtWidgets.QLabel(parent=self.groupBox_11)
        self.label_39.setObjectName("label_39")
        self.formLayout_9.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_39)
        self.currentFpSpin = QtWidgets.QSpinBox(parent=self.groupBox_11)
        ...
        self.formLayout_9.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.currentFpSpin)
        self.label_40 = QtWidgets.QLabel(parent=self.groupBox_11)
        self.label_40.setObjectName("label_40")
        self.formLayout_9.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_40)
        self.maxFpSpin = QtWidgets.QSpinBox(parent=self.groupBox_11)
        self.maxFpSpin.setMinimum(-2147483648)
        self.maxFpSpin.setMaximum(2147483647)
        self.maxFpSpin.setObjectName("maxFpSpin")
        self.formLayout_9.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.maxFpSpin)
        ...
        self.class2Select = ComboBox2DA(parent=self.groupBox_13)
        self.class2Select.setObjectName("class2Select")
        self.horizontalLayout_14.addWidget(self.class2Select)
        self.class2LevelSpin = QtWidgets.QSpinBox(parent=self.groupBox_13)
        ...
        self.featList = QtWidgets.QListWidget(parent=self.featsTab)
        self.featList.setObjectName("featList")
        self.verticalLayout_8.addWidget(self.featList)
        self.groupBox_14 = QtWidgets.QGroupBox(parent=self.featsTab)
        self.groupBox_14.setObjectName("groupBox_14")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.groupBox_14)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.featSummaryEdit = QtWidgets.QPlainTextEdit(parent=self.groupBox_14)
        ...
        self.label_95 = QtWidgets.QLabel(parent=self.Scripts)
        self.label_95.setObjectName("label_95")
        self.formLayout_22.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_95)
        self.horizontalLayout_29 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_29.setObjectName("horizontalLayout_29")
        self.onBlockedEdit = FilterComboBox(parent=self.Scripts)
        self.onBlockedEdit.setObjectName("onBlockedEdit")
        self.horizontalLayout_29.addWidget(self.onBlockedEdit)
        self.formLayout_22.setLayout(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_29)
        self.label_106 = QtWidgets.QLabel(parent=self.Scripts)
        self.label_106.setObjectName("label_106")
        self.formLayout_22.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_106)
        self.horizontalLayout_30 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_30.setObjectName("horizontalLayout_30")
        self.onAttackedEdit = FilterComboBox(parent=self.Scripts)
        self.onAttackedEdit.setObjectName("onAttackedEdit")
        self.horizontalLayout_30.addWidget(self.onAttackedEdit)
        self.formLayout_22.setLayout(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_30)
        self.label_96 = QtWidgets.QLabel(parent=self.Scripts)
        self.label_96.setObjectName("label_96")
        self.formLayout_22.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_96)
        self.horizontalLayout_31 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_31.setObjectName("horizontalLayout_31")
        self.onNoticeEdit = FilterComboBox(parent=self.Scripts)
        self.onNoticeEdit.setObjectName("onNoticeEdit")
        self.horizontalLayout_31.addWidget(self.onNoticeEdit)
        self.formLayout_22.setLayout(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_31)
        self.label_97 = QtWidgets.QLabel(parent=self.Scripts)
        self.label_97.setObjectName("label_97")
        self.formLayout_22.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_97)
        self.horizontalLayout_32 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_32.setObjectName("horizontalLayout_32")
        self.onConversationEdit = FilterComboBox(parent=self.Scripts)
        self.onConversationEdit.setObjectName("onConversationEdit")
        self.horizontalLayout_32.addWidget(self.onConversationEdit)
        self.formLayout_22.setLayout(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_32)
        self.label_98 = QtWidgets.QLabel(parent=self.Scripts)
        self.label_98.setObjectName("label_98")
        self.formLayout_22.setWidget(4, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_98)
        self.horizontalLayout_33 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_33.setObjectName("horizontalLayout_33")
        self.onDamagedEdit = FilterComboBox(parent=self.Scripts)
        self.onDamagedEdit.setObjectName("onDamagedEdit")
        self.horizontalLayout_33.addWidget(self.onDamagedEdit)
        self.formLayout_22.setLayout(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_33)
        self.label_109 = QtWidgets.QLabel(parent=self.Scripts)
        self.label_109.setObjectName("label_109")
        self.formLayout_22.setWidget(5, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_109)
        self.horizontalLayout_34 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_34.setObjectName("horizontalLayout_34")
        self.onDeathEdit = FilterComboBox(parent=self.Scripts)
        self.onDeathEdit.setObjectName("onDeathEdit")
        self.horizontalLayout_34.addWidget(self.onDeathEdit)
        self.formLayout_22.setLayout(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_34)
        self.label_107 = QtWidgets.QLabel(parent=self.Scripts)
        self.label_107.setObjectName("label_107")
        self.formLayout_22.setWidget(6, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_107)
        self.horizontalLayout_35 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_35.setObjectName("horizontalLayout_35")
        self.onEndRoundEdit = FilterComboBox(parent=self.Scripts)
        self.onEndRoundEdit.setObjectName("onEndRoundEdit")
        self.horizontalLayout_35.addWidget(self.onEndRoundEdit)
        self.formLayout_22.setLayout(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_35)
        self.label_108 = QtWidgets.QLabel(parent=self.Scripts)
        self.label_108.setObjectName("label_108")
        self.formLayout_22.setWidget(7, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_108)
        self.horizontalLayout_36 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_36.setObjectName("horizontalLayout_36")
        self.onEndConversationEdit = FilterComboBox(parent=self.Scripts)
        ...
        self.formLayout_22.setLayout(7, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_36)
        self.label_100 = QtWidgets.QLabel(parent=self.Scripts)
        self.label_100.setObjectName("label_100")
        self.formLayout_22.setWidget(8, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_100)
        self.horizontalLayout_38 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_38.setObjectName("horizontalLayout_38")
        self.onDisturbedEdit = FilterComboBox(parent=self.Scripts)
        self.onDisturbedEdit.setObjectName("onDisturbedEdit")
        self.horizontalLayout_38.addWidget(self.onDisturbedEdit)
        self.formLayout_22.setLayout(8, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_38)
        self.label_101 = QtWidgets.QLabel(parent=self.Scripts)
        self.label_101.setObjectName("label_101")
        self.formLayout_22.setWidget(9, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_101)
        self.horizontalLayout_39 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_39.setObjectName("horizontalLayout_39")
        self.onHeartbeatEdit = FilterComboBox(parent=self.Scripts)
        self.onHeartbeatEdit.setObjectName("onHeartbeatEdit")
        self.horizontalLayout_39.addWidget(self.onHeartbeatEdit)
        self.formLayout_22.setLayout(9, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_39)
        self.label_103 = QtWidgets.QLabel(parent=self.Scripts)
        self.label_103.setObjectName("label_103")
        self.formLayout_22.setWidget(10, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_103)
        self.horizontalLayout_41 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_41.setObjectName("horizontalLayout_41")
        self.onSpawnEdit = FilterComboBox(parent=self.Scripts)
        self.onSpawnEdit.setObjectName("onSpawnEdit")
        self.horizontalLayout_41.addWidget(self.onSpawnEdit)
        self.formLayout_22.setLayout(10, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_41)
        self.label_104 = QtWidgets.QLabel(parent=self.Scripts)
        self.label_104.setObjectName("label_104")
        self.formLayout_22.setWidget(11, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_104)
        self.horizontalLayout_42 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_42.setObjectName("horizontalLayout_42")
        self.onSpellCastEdit = FilterComboBox(parent=self.Scripts)
        self.onSpellCastEdit.setObjectName("onSpellCastEdit")
        self.horizontalLayout_42.addWidget(self.onSpellCastEdit)
        self.formLayout_22.setLayout(11, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_42)
        self.label_105 = QtWidgets.QLabel(parent=self.Scripts)
        self.label_105.setObjectName("label_105")
        self.formLayout_22.setWidget(12, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_105)
        self.horizontalLayout_43 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_43.setObjectName("horizontalLayout_43")
        self.onUserDefinedEdit = FilterComboBox(parent=self.Scripts)
        self.onUserDefinedEdit.setObjectName("onUserDefinedEdit")
        self.horizontalLayout_43.addWidget(self.onUserDefinedEdit)
        self.formLayout_22.setLayout(12, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_43)
        ...
        self.comments = QtWidgets.QPlainTextEdit(parent=self.commentsTab)
        ...
        self.actionSaveUnusedFields = QtGui.QAction(parent=MainWindow)
        self.actionSaveUnusedFields.setCheckable(True)
        self.actionSaveUnusedFields.setObjectName("actionSaveUnusedFields")
        self.actionAlwaysSaveK2Fields = QtGui.QAction(parent=MainWindow)
