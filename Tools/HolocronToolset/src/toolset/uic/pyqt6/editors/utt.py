...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout_5.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.onHeartbeatSelect)
        ...
        self.formLayout_5.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.onExitSelect)
        self.onEnterSelect = FilterComboBox(parent=self.tab_4)
        self.onEnterSelect.setObjectName("onEnterSelect")
        self.formLayout_5.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.onEnterSelect)
        self.onUserDefinedSelect = FilterComboBox(parent=self.tab_4)
        self.onUserDefinedSelect.setObjectName("onUserDefinedSelect")
        self.formLayout_5.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.onUserDefinedSelect)
