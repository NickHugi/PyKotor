...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.walkmeshToolbar = QtWidgets.QToolBar(parent=self.centralwidget)
...
"                                    ")
        ...
        self.instanceList = QtWidgets.QListWidget(parent=self.dockWidgetContents)
        self.instanceList.setGeometry(QtCore.QRect(0, -20, 200, 495))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.actionSave1 = QtGui.QAction(parent=MainWindow)
        ...
        self.actionUndo1 = QtGui.QAction(parent=MainWindow)
        self.actionUndo1.setShortcut("")
        self.actionUndo1.setObjectName("actionUndo1")
        self.actionRedo1 = QtGui.QAction(parent=MainWindow)
        ...
        self.actionToggleWireframe = QtGui.QAction(parent=MainWindow)
        ...
        self.actionToggleTextures = QtGui.QAction(parent=MainWindow)
        ...
        self.actionShowHideWalkmesh = QtGui.QAction(parent=MainWindow)
        ...
        self.actionShowHideLYT = QtGui.QAction(parent=MainWindow)
        ...
        self.actionWalkmeshEditor = QtGui.QAction(parent=MainWindow)
        self.actionWalkmeshEditor.setCheckable(False)
        self.actionWalkmeshEditor.setObjectName("actionWalkmeshEditor")
        self.actionLYTEditor = QtGui.QAction(parent=MainWindow)
        self.actionLYTEditor.setCheckable(False)
        self.actionLYTEditor.setObjectName("actionLYTEditor")
        self.actionGenerateWalkmesh = QtGui.QAction(parent=MainWindow)
        self.actionGenerateWalkmesh.setObjectName("actionGenerateWalkmesh")
        self.actionOptimizeWalkmesh = QtGui.QAction(parent=MainWindow)
        self.actionOptimizeWalkmesh.setObjectName("actionOptimizeWalkmesh")
        self.actionGenerateLYT = QtGui.QAction(parent=MainWindow)
        self.actionGenerateLYT.setObjectName("actionGenerateLYT")
        self.actionOptimizeLYT = QtGui.QAction(parent=MainWindow)
        self.actionOptimizeLYT.setObjectName("actionOptimizeLYT")
        self.actionInstructions1 = QtGui.QAction(parent=MainWindow)
        self.actionInstructions1.setObjectName("actionInstructions1")
        self.actionAbout = QtGui.QAction(parent=MainWindow)
        self.actionAbout.setObjectName("actionAbout")
        self.actionAddWalkmeshFace = QtGui.QAction(parent=MainWindow)
        self.actionAddWalkmeshFace.setObjectName("actionAddWalkmeshFace")
        self.actionRemoveWalkmeshFace = QtGui.QAction(parent=MainWindow)
        self.actionRemoveWalkmeshFace.setObjectName("actionRemoveWalkmeshFace")
        self.actionMergeWalkmeshFaces = QtGui.QAction(parent=MainWindow)
        self.actionMergeWalkmeshFaces.setObjectName("actionMergeWalkmeshFaces")
        self.actionSplitWalkmeshFace = QtGui.QAction(parent=MainWindow)
        self.actionSplitWalkmeshFace.setObjectName("actionSplitWalkmeshFace")
        self.actionSetWalkmeshMaterial = QtGui.QAction(parent=MainWindow)
        self.actionSetWalkmeshMaterial.setObjectName("actionSetWalkmeshMaterial")
        self.actionAddRoom = QtGui.QAction(parent=MainWindow)
        self.actionAddRoom.setObjectName("actionAddRoom")
        self.actionRemoveRoom = QtGui.QAction(parent=MainWindow)
        self.actionRemoveRoom.setObjectName("actionRemoveRoom")
        self.actionConnectRooms = QtGui.QAction(parent=MainWindow)
        self.actionConnectRooms.setObjectName("actionConnectRooms")
        self.actionAddObstacle = QtGui.QAction(parent=MainWindow)
        self.actionAddObstacle.setObjectName("actionAddObstacle")
        self.actionRemoveObstacle = QtGui.QAction(parent=MainWindow)
        self.actionRemoveObstacle.setObjectName("actionRemoveObstacle")
        self.actionAddTrack = QtGui.QAction(parent=MainWindow)
        self.actionAddTrack.setObjectName("actionAddTrack")
        self.actionRemoveTrack = QtGui.QAction(parent=MainWindow)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionSave1.setText(_translate("MainWindow", "Save"))
        self.actionSaveAs.setText(_translate("MainWindow", "Save As..."))
        self.actionExit.setText(_translate("MainWindow", "Exit"))
        self.actionUndo1.setText(_translate("MainWindow", "Undo"))
        self.actionRedo1.setText(_translate("MainWindow", "Redo"))
        ...
        self.actionInstructions1.setText(_translate("MainWindow", "Instructions"))
