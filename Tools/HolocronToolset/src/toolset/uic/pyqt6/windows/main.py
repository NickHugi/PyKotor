...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/images/icons/sith.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.specialActionButton.sizePolicy().hasHeightForWidth())
        self.specialActionButton.setSizePolicy(sizePolicy)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/images/icons/kx/creature.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        self.actionNewUTC.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/images/icons/kx/placeable.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionNewUTP.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/images/icons/kx/door.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionNewUTD.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/images/icons/kx/waypoint.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionNewUTW.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/images/icons/kx/trigger.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionNewUTT.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/images/icons/kx/encounter.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionNewUTE.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/images/icons/kx/sound.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionNewUTS.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/images/icons/kx/merchant.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionNewUTM.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/images/icons/kx/tlk.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionNewTLK.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/images/icons/kx/item.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionNewUTI.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/images/icons/kx/dialog.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionNewDLG.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/images/icons/kx/script.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionNewNSS.setIcon(icon12)
        ...
        self.neonButtons = QtGui.QAction(parent=MainWindow)
        self.neonButtons.setObjectName("neonButtons")
        self.ubuntu = QtGui.QAction(parent=MainWindow)
        ...
        self.menuTheme.addAction(self.neonButtons)
        self.menuTheme.addAction(self.ubuntu)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.neonButtons.setText(_translate("MainWindow", "NeonButtons"))
        self.ubuntu.setText(_translate("MainWindow", "Ubuntu"))
