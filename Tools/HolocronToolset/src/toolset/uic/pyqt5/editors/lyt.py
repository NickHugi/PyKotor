...
class Ui_LYTEditor(object):
    def setupUi(self, LYTEditor):
        ...
        self.viewTabWidget = QtWidgets.QTabWidget(self.leftWidget)
        ...
        self.graphicsView = QtWidgets.QGraphicsView(self.topDownTab)
        ...
        self.openGLWidget = QtWidgets.QOpenGLWidget(self.threeDTab)
