...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.plotXpSpin = QtWidgets.QDoubleSpinBox(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.speakerEditLabel = QtWidgets.QLabel(self.centralwidget)
        self.speakerEditLabel.setObjectName("speakerEditLabel")
        self.gridLayout.addWidget(self.speakerEditLabel, 1, 0, 1, 1, QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)
        ...
        self.plotIndexLabel = QtWidgets.QLabel(self.centralwidget)
        self.plotIndexLabel.setObjectName("plotIndexLabel")
        self.gridLayout.addWidget(self.plotIndexLabel, 2, 2, 1, 1, QtCore.Qt.AlignRight)
        ...
        self.horizontalLayout_2.addWidget(self.script2Label, 0, QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.horizontalLayout_3.addWidget(self.conditional1Label, 0, QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.horizontalLayout_4.addWidget(self.conditional2Label, 0, QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.topGridLayout.addWidget(self.convoTypeLabel, 2, 0, 1, 1, QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)
        self.skippableCheckbox = QtWidgets.QCheckBox(self.topDockWidgetContents)
        ...
        self.unequipAllCheckbox = QtWidgets.QCheckBox(self.topDockWidgetContents)
        ...
        self.topGridLayout.addWidget(self.convoAbortsScriptLabel, 1, 0, 1, 1, QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)
        ...
        self.topGridLayout.addWidget(self.computerTypeLabel, 3, 0, 1, 1, QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)
        ...
        self.unequipHandsCheckbox = QtWidgets.QCheckBox(self.topDockWidgetContents)
        ...
        self.animatedCutCheckbox = QtWidgets.QCheckBox(self.topDockWidgetContents)
        ...
        self.oldHitCheckbox = QtWidgets.QCheckBox(self.topDockWidgetContents)
        self.oldHitCheckbox.setObjectName("oldHitCheckbox")
        self.topGridLayout.addWidget(self.oldHitCheckbox, 3, 4, 1, 1, QtCore.Qt.AlignLeft)
