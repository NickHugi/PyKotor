...
class EncounterDialog(QDialog):
    def __init__(self, parent: QWidget, encounter: GITEncounter):
        ...
        if qtpy.API_NAME == "PySide2":
            from toolset.uic.pyside2.dialogs.instance.encounter import (
                Ui_Dialog,  # noqa: PLC0415  # pylint: disable=C0415
            )
        elif qtpy.API_NAME == "PySide6":
            from toolset.uic.pyside6.dialogs.instance.encounter import (
                Ui_Dialog,  # noqa: PLC0415  # pylint: disable=C0415
            )
        elif qtpy.API_NAME == "PyQt5":
            from toolset.uic.pyqt5.dialogs.instance.encounter import (
                Ui_Dialog,  # noqa: PLC0415  # pylint: disable=C0415
            )
        elif qtpy.API_NAME == "PyQt6":
            from toolset.uic.pyqt6.dialogs.instance.encounter import (
                Ui_Dialog,  # noqa: PLC0415  # pylint: disable=C0415
            )
        else:
