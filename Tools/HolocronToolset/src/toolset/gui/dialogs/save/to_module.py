...
class SaveToModuleDialog(QDialog):
    ...
    def __init__(self, resname: str, restype: ResourceType, supported: list[ResourceType]):
        ...
        if qtpy.API_NAME == "PySide2":
            from toolset.uic.pyside2.dialogs.save_to_module import (
                Ui_Dialog,  # noqa: PLC0415  # pylint: disable=C0415
            )
        elif qtpy.API_NAME == "PySide6":
            from toolset.uic.pyside6.dialogs.save_to_module import (
                Ui_Dialog,  # noqa: PLC0415  # pylint: disable=C0415
            )
        elif qtpy.API_NAME == "PyQt5":
            from toolset.uic.pyqt5.dialogs.save_to_module import (
                Ui_Dialog,  # noqa: PLC0415  # pylint: disable=C0415
            )
        elif qtpy.API_NAME == "PyQt6":
            from toolset.uic.pyqt6.dialogs.save_to_module import (
                Ui_Dialog,  # noqa: PLC0415  # pylint: disable=C0415
            )
        else:
