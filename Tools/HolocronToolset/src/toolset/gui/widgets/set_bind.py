...
class SetBindWidget(QWidget):
    def __init__(self, parent: QWidget):
        ...
        if qtpy.API_NAME == "PySide2":
            from toolset.uic.pyside2.widgets.set_bind import (
                Ui_Form,  # noqa: PLC0415  # pylint: disable=C0415
            )
        elif qtpy.API_NAME == "PySide6":
            from toolset.uic.pyside6.widgets.set_bind import (
                Ui_Form,  # noqa: PLC0415  # pylint: disable=C0415
            )
        elif qtpy.API_NAME == "PyQt5":
            from toolset.uic.pyqt5.widgets.set_bind import (
                Ui_Form,  # noqa: PLC0415  # pylint: disable=C0415
            )
        elif qtpy.API_NAME == "PyQt6":
            from toolset.uic.pyqt6.widgets.set_bind import (
                Ui_Form,  # noqa: PLC0415  # pylint: disable=C0415
            )
        else:
